...
from .views import all_project, project_detail, add_comment, report_project, create_project, deleteProject,rate_project,myprojects,report_comment, edit_project
